...
The last of those is a TOOL limitation, not the convention: semantic line breaks
apply wherever the rendered output is unchanged, which includes list items and
blockquote paragraphs. Extending this script to cover them, and adding unit
tests, is tracked in https://github.com/flungo/claude-plugins/issues/16.
